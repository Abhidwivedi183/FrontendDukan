...
const setsubmit = (e)=>{
    e.preventDefault();
   try {
     const mes = axios.post("https://backenddukkan.onrender.com/api/products",data);
    setmsg(mes.message);
  ...
  return (
    <div style={{margin:"30px",backgroundColor:"Red",height:"450px",width:"400px", display:"flex", flexDirection:"column", gap:"10px", justifyItems:"space-between",justifyContent:"center",alignItems:"center" ,position:"absolute",top:"120px",left:"505px" , borderRadius:"5%"}}>
      ...
      <input type  = "password" placeholder='Price' name = "price" style  = {{height:"40px",width:"80%"}} value ={data.price} onChange={change}/>
